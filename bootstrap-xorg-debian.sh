...
aptitude install bzip2 sudo rsync openssh-server git-core pkg-config build-essential autoconf libtool python mlocate xsltproc libexpat1-dev libfreetype6-dev libssl-dev
